...
public class ItemCarrinhoDTO {
    ...
    public ItemCarrinhoDTO(Long id, @NotNull(message = "ID do produto é obrigatório") Long produtoId, String nomeProduto, @NotNull(message = "Quantidade é obrigatória") @Positive(message = "Quantidade deve ser maior que zero") Integer quantidade, BigDecimal precoUnitario, BigDecimal subtotal) {
        this.id = id;
    ...
    public @NotNull(message = "ID do produto é obrigatório") Long getProdutoId() {
    ...
    public void setProdutoId(@NotNull(message = "ID do produto é obrigatório") Long produtoId) {
        this.produtoId = produtoId;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ItemCarrinhoDTO)) return false;
        final ItemCarrinhoDTO other = (ItemCarrinhoDTO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ItemCarrinhoDTO;
    }
    ...
    public String toString() {
        return "ItemCarrinhoDTO(id=" + this.getId() + ", produtoId=" + this.getProdutoId() + ", nomeProduto=" + this.getNomeProduto() + ", quantidade=" + this.getQuantidade() + ", precoUnitario=" + this.getPrecoUnitario() + ", subtotal=" + this.getSubtotal() + ")";
    }
}